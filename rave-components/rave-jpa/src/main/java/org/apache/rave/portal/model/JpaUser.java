...
public class JpaUser extends JpaPerson implements BasicEntity, Serializable, User {
    ...
    public JpaUser(Long entityId, String username,String encrypt) {
        super();
    ...
    public String toString() {
        ...
        sb.append(", extension='").append(extensionNumber).append('\'');
    ...
    public Person toPerson() {
        ...
        p.setMobileNumber(this.getMobileNumber());
        p.setExtensionNumber(this.getExtensionNumber());
        p.setEncrypt(this.getEncrypt());
