...
public class NewAccountController {
    ...
    @Autowired
    public NewAccountController(NewAccountService newAccountService, NewAccountValidator newAccountValidator, CaptchaService captchaService, UserService userService) {
	...
	public @ResponseBody String getOnlineUser(@PathVariable("ownerId") String ownerId){		
    	return userService.getOnlineUsers(ownerId);
	}*/
