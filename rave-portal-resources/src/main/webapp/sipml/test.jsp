...
<%@ page import="org.apache.rave.portal.model.User"%>
<%
	SecurityContextImpl context= new SecurityContextImpl();
	context= (SecurityContextImpl) session.getAttribute("SPRING_SECURITY_CONTEXT");
...
<head>
	...
	<script src="js/cross-frame.js"></script>
	...
	<script type="text/javascript">
		(function (){ YAHOO.util.CrossFrame.onMessageEvent.subscribe(function (type, args, obj) {
				var message = args[0];
				var domain = args[1];
				//alert(message);
				directSipCall(message);
		}); 
		})();
	</script>
...
<script type="text/javascript">
    ...
    window.onload = function () {
		rsound = loadSound("ringing.ogg");
		////////////////////////////VIKASH///////////////////////
	
	document.getElementById('txtRealm').value = "asterisk";
    ...
    function sipRegister() {
        ...
        try {
            ...
            oSipStack = new SIPml.Stack({
                    ...
                    sip_headers: [
                            { name: 'User-Agent', value: 'IM-client/OMA1.0 sipML5-v1.2013.03.27' },
	...
	function directSipCall(exten) {
        ...
        if (oSipStack && !oSipSessionCall && !tsk_string_is_null_or_empty(exten)) {
            btnCall.disabled = true;
            btnHangUp.disabled = false;
            ...
            oSipSessionCall = oSipStack.newSession(bDisableVideo ? 'call-audio' : 'call-audiovideo', oConf);
            // make call
            if (oSipSessionCall.call(exten) != 0) {
                oSipSessionCall = null;
                txtCallStatus.value = 'Failed to make call';
                btnCall.disabled = false;
                btnHangUp.disabled = true;
    ...
    function startRingTone() {
        try { ringtone.play();rsound.play(); }
        catch (e) { }
    }

    function stopRingTone() {
        try { ringtone.pause(); rsound.pause();}
        catch (e) { }
    }

    function startRingbackTone() {
        try { ringbacktone.play(); rsound.play();}
        catch (e) { }
    }

    function stopRingbackTone() {
        try { ringbacktone.pause(); rsound.pause();}
        catch (e) { }
    }
...
<body style="cursor:default">
   <!-- <div class="navbar navbar-fixed-top">
    ...
    <div class="container">
        <div class="row-fluid">
            <div class="span4 well" style="display:none;">
                ...
                <table style='width: 100%'>
                    <tr>
                       <!-- <td>
                        ...
                        <td>
                            <input type="hidden" style="width: 100%; height: 100%" id="txtDisplayName" value="<%=user.getExtensionNumber()%>"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" style="width: 100%; height: 100%" id="txtPrivateIdentity" value="<%=user.getExtensionNumber()%>"
                    ...
                    <tr>
                       <!-- <td>
                        ...
                        <td>
                            <input type="hidden" style="width: 100%; height: 100%" id="txtPublicIdentity" value="sip:<%=user.getExtensionNumber()%>@10.36.76.98"
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" style="width: 100%; height: 100%" id="txtPassword" value="<%=user.getExtensionNumber()%>" />
                        </td>
                    </tr>
                    <tr>
                        <!--<td>
                        ...
                        <td>
                            <input type="hidden" style="width: 100%; height: 100%" id="txtRealm" value="" placeholder="e.g. doubango.org" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" align="right">
							<a style="display:none;" href="./expert.htm" target="_blank">Expert</a>&nbsp;
                            <input type="button" style="display:none;" class="btn-success" id="btnRegister" value="LogIn" disabled onclick='sipRegister();' />
                            &nbsp;
                            <input type="button" style="display:none;" class="btn-danger" id="btnUnRegister" value="LogOut" disabled onclick='sipUnRegister();' />
							<!--<input type="button" class="btn-primary" style="" id="btnHangUp1" value="HangUp" onclick='sipHangUp();' /> -->
            ...
            <div id="divCallCtrl" class="span7 well" style="height:103px;">
                ...
                <table style='width: 100%;'>
                    ...
                    <tr>
                       <td align='center'>
                            <div id='divCallOptions' class='' style='opacity: 0; margin-top: 0px; height: 0px;width:0px;'>
                                <input type="button" class="btn" style="display:none;" id="btnFullScreen" value="FullScreen" disabled onclick='toggleFullScreen();' /> &nbsp;
                                <input type="button" style="display:none;" class="btn"  id="btnHoldResume" value="Hold" onclick='sipToggleHoldResume();' /> &nbsp;
                                <input type="button" style="display:none;" class="btn"  id="btnTransfer" value="Transfer" onclick='sipTransfer();' /> &nbsp;
					...
					<tr>
                        <td style="white-space:nowrap;">
                            <input type="hidden" style="width: 100%; height:100%" id="txtPhoneNumber" value="" placeholder="Enter phone number to call" />                            
                        </td>
                    </tr>
                    <tr>
                        <td colspan="1" align="center">
							<a href="javascript:void(0);" onclick="directSipCall('1062');" style="display:;">Call</a>&nbsp;&nbsp;
        ...
        <br />
        <footer style="width:0px;height:0px;">
           <!-- <p>&copy; Doubango Telecom 2012 <br />
            ...
            -->
            <object id="fakeVideoDisplay" classid="clsid:5C2C407B-09D9-449B-BB83-C39B7802A684" style="visibility:hidden;width:0px;height:0px;"> </object>
            <object id="fakeLooper" classid="clsid:7082C446-54A8-4280-A18D-54143846211A" style="visibility:hidden;width:0px;height:0px;"> </object>
            <object id="fakeSessionDescription" classid="clsid:DBA9F8E2-F9FB-47CF-8797-986A69A1CA9C" style="visibility:hidden;width:0px;height:0px;"> </object>
            <object id="fakeNetTransport" classid="clsid:5A7D84EC-382C-4844-AB3A-9825DBE30DAE" style="visibility:hidden;width:0px;height:0px;"> </object>
            <object id="fakePeerConnection" classid="clsid:56D10AD3-8F52-4AA4-854B-41F4D6F9CEA3" style="visibility:hidden;width:0px;height:0px;"> </object>
            <!-- 
    ...
    <!-- KeyPad Div -->
    <div id='divKeyPad' class='span2 well div-keypad' style="left:0px; top:0px; width:0; height:0; visibility:hidden">
