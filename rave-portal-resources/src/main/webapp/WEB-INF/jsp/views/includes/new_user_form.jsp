...
document.getElementById("emailField").value=v;
...
<form:form cssClass="form-horizontal" id="newAccountForm" commandName="newUser" action="newaccount" method="POST">
    <fieldset>
		...
		<div class="control-group">
            <label class="control-label" for="firstNameField">Name:</label>
            <div class="controls"><form:input id="firstNameField" required="required" path="givenName" autofocus="autofocus"/>
      ...
      <!--  <div class="control-group">
		 ...
		 <div class="control-group">
            <label class="control-label" for="userNameField">Email Address:</label>
            <div class="controls">
                <form:input id="userNameField" path="username" required="required" autofocus="autofocus"  onblur="email12(this.value)" />
		...
		<div class="control-group" >
            <label class="control-label" for="emailField">Mobile Number:</label>
            <div class="controls">
                <input required="required" type="text" name="mobileNumber" />
            </div>
        </div>
